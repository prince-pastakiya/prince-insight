			...
			<form className="space-y-3 @md/form:space-y-4" onSubmit={handleSubmit}>
				...
				<div>
					...
					<input
						...
						name="subject"
						className="w-full px-3 py-1.5 @md/form:px-4 @md/form:py-2 rounded-lg border bg-background focus:outline-none focus:ring-2 focus:ring-primary text-sm @md/form:text-base"
						placeholder="Reason for Reaching Out (Job Opportunity / Collaboration)"
						required
						disabled={isPending}
					/>
				</div>
				...
				<div>
					...
					<textarea
						...
						placeholder="I came across your portfolio and would like to explore job opportunities or professional collaboration."
						required
						disabled={isPending}
					/>
				</div>
