...
This document provides a detailed overview of all the dummy data available for
your Sanity portfolio.
...
**Document ID:** `singleton-siteSettings` (configured as singleton in
structure.ts)
