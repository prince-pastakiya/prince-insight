...
set FILES=skills.ndjson profile.ndjson education.ndjson experience.ndjson projects.ndjson achievements.ndjson certifications.ndjson navigation.ndjson siteSettings.ndjson contact.ndjson
